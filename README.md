...
当前版本以 KernelSU `webroot` 为主，旧的本地端口 WebUI 已弃用。项目不包含开机自启。
...
This release uses KernelSU `webroot` as the primary UI path. The old local port-based WebUI is deprecated. This project does not include autostart.
